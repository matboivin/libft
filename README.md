...
|[ft_iscntrl](src/ft_iscntrl.c)|Checks if `c` is a control character |
|[ft_isdigit](src/ft_isdigit.c)       |Checks if `c` is a numeric character |
|[ft_islower](src/ft_islower.c)|Checks if `c` is a lower-case character |
...
|[ft_isupper](src/ft_isupper.c)|Checks if `c` is a upper-case character |
...
|[ft_lstdelif](src/ft_lstdelif.c)     |Erases off the list all elements, whose data is "equal" to the reference data |
